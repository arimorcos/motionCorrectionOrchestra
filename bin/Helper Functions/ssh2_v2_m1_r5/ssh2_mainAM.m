...
%     ssh2_struct.command_session.execCommand(ssh2_struct.command);
    ssh2_struct.command_session.requestPTY('bash');
    ssh2_struct.command_session.startShell();
    stdin = OutputStreamWriter(ssh2_struct.command_session.getStdin(), 'utf-8');
    try
        stdin.write(ssh2_struct.command);
    catch err
    end
